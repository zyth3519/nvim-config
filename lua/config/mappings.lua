...
require("config.mappings.window")
require("config.mappings.search")
require("config.mappings.file")
require("config.mappings.git")
require("config.mappings.cursor")
require("config.mappings.coding")
require("config.mappings.debug")
require("config.mappings.task")
